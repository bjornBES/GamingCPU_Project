...
{
    public static Dictionary<Instruction, InstructionInfo> instr;
    public Instructions()
    {
        instr = new Dictionary<Instruction, InstructionInfo>()
        {
            ...
            { Instruction.MOVWRA,   new InstructionInfo(1,Instruction.MOVWRA, CPUType.BC16)},
            ...
            { Instruction.CMP,      new InstructionInfo(2,Instruction.CMP, CPUType.BC8)},
            { Instruction.PUSH,     new InstructionInfo(1,Instruction.PUSH, CPUType.BC8)},
            ...
            { Instruction.SEZRA,    new InstructionInfo(0,Instruction.SEZRA, CPUType.BC16)},
            ...
            { Instruction.TESTRA,   new InstructionInfo(0,Instruction.TESTRA, CPUType.BC16)},
            ...
            { Instruction.CMPSTR,   new InstructionInfo(2,Instruction.CMPSTR, CPUType.BC8)},
            ...
            { Instruction.BRK,      new InstructionInfo(1,Instruction.BRK, CPUType.BC8)},
