...
public class Registers
{
    public static Dictionary<Register, RegisterInfo> m_Regs = new Dictionary<Register, RegisterInfo>()
    {
        ...
        { Register.R17, new RegisterInfo(Register.R17,  CPUType.BC16) },
        { Register.R18, new RegisterInfo(Register.R18,  CPUType.BC16) },
        { Register.R19, new RegisterInfo(Register.R19,  CPUType.BC16) },
        { Register.R20, new RegisterInfo(Register.R20,  CPUType.BC16) },
