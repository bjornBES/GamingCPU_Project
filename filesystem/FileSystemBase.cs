...
namespace filesystem
{
    public class FileSystemBase
    {
        ...
        internal delegate byte[] ReadSectorFunc(byte head, ushort track, ushort sector);
        ...
        internal ReadSectorFunc m_readSector;
        ...
        public void CreateDisk(Disk disk)
        {
            ...
            m_Heads = (byte)disk.NumberOfHeads;
            m_DiskSize = disk.m_DiskSize; // 20 MB
            m_TracksPerHead = (ushort)disk.TracksPerSurface;
