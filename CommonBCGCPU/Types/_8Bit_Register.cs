...
namespace CommonBCGCPU.Types
{
    ...
    public struct _8Bit_Register
    {
        ...
        public _8Bit_Register(uint value)
        {
            m_Value = (byte)value;
        }
        ...
        public static implicit operator _8Bit_Register(uint value)
        {
            return new _8Bit_Register(value);
        }
        ...
        public string ToHex()
        {
            return Convert.ToString(m_Value, 16).PadLeft(2, '0');
        }
        public string ToBin()
        {
            return Convert.ToString(m_Value, 2).PadLeft(8, '0');
        }
    }
}
