...
namespace CommonBCGCPU.Types
{
    ...
    public struct _32BitFloatRegister
    {
        ...
        public static implicit operator uint(_32BitFloatRegister register)
        {
            return Convert.ToUInt32(register.m_Value);
        }
        ...
        public string ToHex()
        {
            return Convert.ToString((uint)m_Value, 16).PadLeft(8, '0');
        }
    }
}
