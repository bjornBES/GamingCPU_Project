...
namespace BC16CPUEmulator
{
    public class Program : ArgumentFunctions
    {
        ...
        void writeInfo(BC16CPU cpu)
        {
            ...
            Console.WriteLine($"");
            Console.WriteLine($"DS:\t0x{cpu.m_EDS.ToHex()} ES:\t0x{cpu.m_EES.ToHex()}");
            Console.WriteLine($"SS:\t0x{cpu.m_ESS.ToHex()} CS:\t0x{cpu.m_ECS.ToHex()}");
            Console.WriteLine($"");
            ...
            Console.WriteLine($"");
            Console.WriteLine($"CR0:\t0b{cpu.m_CR0.ToBin()}");
            Console.WriteLine($"");
