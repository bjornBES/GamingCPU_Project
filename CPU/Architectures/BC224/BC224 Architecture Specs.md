...
|-------------|-----------|-----------------------|-
|`0x0000_0000`|`0x00_2000`| Interrupt vector table| Interrupt vector table more [here](#interrupt-vector-table)
|`0x0000_2000`|`0x00_0200`| IO ports              | this is where the Ports is at
|`0x0000_2200`|`0x00_EE00`| RAM                   | RAM in the first segment
