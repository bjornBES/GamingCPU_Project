namespace ConsoleGameEngine {
	...
	class ConsoleBuffer {
		...
		public ConsoleBuffer(int w, int he) {
			...
			h = NativeMethods.CreateFile("CONOUT$", (uint)NativeMethods.FileAccess.GENERIC_WRITE, 2, IntPtr.Zero, FileMode.Open, 0, IntPtr.Zero);
		...
		public void SetBuffer(Glyph[,] GlyphBuffer, byte defualtBackground)
		{
